...
class ApplicationMain {
	...
	public static function main() {
		...
		//nme.Lib.setPackage("Jonas Nyström", "Nx3OpenFLTest", "nx3.test.openfl.Nx3OpenFLTest", "1.0.0");
	...
	private static function begin() {
		...
		for (methodName in Type.getClassFields(nx3.test.openfl.Main))
		{
			if (methodName == "main")
			{
				hasMain = true;
		...
		if (hasMain)
		{
			Reflect.callMethod(nx3.test.openfl.Main, Reflect.field (nx3.test.openfl.Main, "main"), []);
		}
		else
		{
...
class DocumentClass extends nx3.test.openfl.Main { }
