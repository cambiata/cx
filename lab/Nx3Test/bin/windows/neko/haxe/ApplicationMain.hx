...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("Jonas Nyström", "Nx3Test", "nx3.test.Nx3Test", "1.0.0");
		...
		flash.Lib.create (function () {
				...
				for (methodName in Type.getClassFields (nx3.test.Main)) {
				...
				if (hasMain) {
					...
					Reflect.callMethod (nx3.test.Main, Reflect.field (nx3.test.Main, "main"), []);
...
@:keep class DocumentClass extends nx3.test.Main {}
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "Nx3Test", null, { width: 800, height: 480 });
			...
			if (hasMain) {
				...
				var instance = Type.createInstance (nx3.test.Main, []);
			}
