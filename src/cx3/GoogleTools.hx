...
class Documents  {
	...
	private var documentEntries:Map<String, DocumentEntry>;
	public function getDocumentEntries():Map<String, DocumentEntry> {
	...
	static private function _getDocumentEntries(xmlDocumentList:String):Map<String, DocumentEntry> {		
		var ret = new Map<String, DocumentEntry>();		
