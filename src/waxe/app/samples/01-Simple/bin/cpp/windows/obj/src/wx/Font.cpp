...
Void Font_obj::__construct(int size,Dynamic __o_family,Dynamic __o_style,Dynamic __o_weight,Dynamic __o_underline,Dynamic __o_faceName)
{
...
{
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Font.hx",29)
...
hx::ObjectPtr< Font_obj > Font_obj::__new(int size,Dynamic __o_family,Dynamic __o_style,Dynamic __o_weight,Dynamic __o_underline,Dynamic __o_faceName)
...
Dynamic Font_obj::wxGetHandle( ){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Font.hx",32)
