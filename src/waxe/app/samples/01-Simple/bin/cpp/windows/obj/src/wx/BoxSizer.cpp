...
{
{
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/BoxSizer.hx",5)
...
::wx::BoxSizer BoxSizer_obj::create( bool inVertical){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/BoxSizer.hx",8)
...
Dynamic BoxSizer_obj::__Field(const ::String &inName)
{
...
Dynamic BoxSizer_obj::__SetField(const ::String &inName,const Dynamic &inValue)
{
	switch(inName.length) {
	case 19:
