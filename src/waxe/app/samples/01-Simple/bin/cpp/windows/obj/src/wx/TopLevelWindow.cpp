...
{
{
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/TopLevelWindow.hx",6)
...
Dynamic TopLevelWindow_obj::__Field(const ::String &inName)
{
	return super::__Field(inName);
}

Dynamic TopLevelWindow_obj::__SetField(const ::String &inName,const Dynamic &inValue)
{
