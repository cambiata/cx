...
{
{
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Sizer.hx",37)
	this->wxHandle = inHandle;
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Sizer.hx",38)
	if (((this->wxHandle != null()))){
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Sizer.hx",39)
...
Void Sizer_obj::_wx_deleted( ){
{
		...
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Sizer.hx",41)
		this->wxHandle = null();
	}
return null();
}
...
Void Sizer_obj::add( Dynamic sizerOrWindow,Dynamic __o_proportion,Dynamic __o_flag,Dynamic __o_border){
...
{
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Sizer.hx",45)
		Dynamic handle = ::Reflect_obj::field(sizerOrWindow,HX_CSTRING("wxHandle"));
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Sizer.hx",46)
...
Void Sizer_obj::addSpacer( int inSize){
{
		...
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Sizer.hx",49)
...
Void Sizer_obj::addStretchSpacer( int inProportion){
{
		...
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Sizer.hx",53)
...
Void Sizer_obj::setSizeHints( ::wx::Window inWindow){
{
		...
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Sizer.hx",60)
...
Void Sizer_obj::fit( ::wx::Window inWindow){
{
		...
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Sizer.hx",65)
...
Dynamic Sizer_obj::wxGetHandle( ){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Sizer.hx",68)
...
Dynamic Sizer_obj::__Field(const ::String &inName)
{
...
Dynamic Sizer_obj::__SetField(const ::String &inName,const Dynamic &inValue)
{
	switch(inName.length) {
	case 6:
