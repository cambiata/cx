...
{
{
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Window.hx",80)
	super::__construct(inHandle);
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Window.hx",81)
...
Void Window_obj::HandleEvent( Dynamic event){
{
		...
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Window.hx",87)
		int type = event->__Field(HX_CSTRING("type"));
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Window.hx",90)
		{
		}
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Window.hx",96)
		if ((this->wxEventHandlers->exists(type))){
			HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Window.hx",98)
			Dynamic func = this->wxEventHandlers->get(type);
			HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Window.hx",99)
			if (((func != null()))){
				HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Window.hx",101)
				event->__FieldRef(HX_CSTRING("skip")) = false;
				HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Window.hx",102)
...
HX_DEFINE_DYNAMIC_FUNC1(Window_obj,HandleEvent,(void))

Void Window_obj::setHandler( ::wx::EventID inID,Dynamic inFunc){
{
		HX_SOURCE_PUSH("Window_obj::setHandler")
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Window.hx",108)
...
Void Window_obj::fit( ){
{
		...
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Window.hx",112)
...
Void Window_obj::refresh( ){
{
		...
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Window.hx",113)
...
Void Window_obj::destroy( ){
{
		...
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Window.hx",114)
...
Dynamic Window_obj::getSize( ){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Window.hx",116)
...
Dynamic Window_obj::setSize( Dynamic inSize){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Window.hx",119)
	::wx::Window_obj::wx_window_set_size(this->wxHandle,inSize);
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Window.hx",120)
	return inSize;
}
...
::wx::Sizer Window_obj::getSizer( ){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Window.hx",123)
...
::wx::Sizer Window_obj::setSizer( ::wx::Sizer inSizer){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Window.hx",126)
	::wx::Window_obj::wx_window_set_sizer(this->wxHandle,inSizer->wxGetHandle());
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Window.hx",127)
	return inSizer;
}
...
Dynamic Window_obj::getClientSize( ){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Window.hx",130)
...
Dynamic Window_obj::setClientSize( Dynamic inSize){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Window.hx",133)
	::wx::Window_obj::wx_window_set_client_size(this->wxHandle,inSize->__Field(HX_CSTRING("width")),inSize->__Field(HX_CSTRING("height")));
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Window.hx",134)
	return inSize;
}
...
Dynamic Window_obj::getPosition( ){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Window.hx",137)
...
Dynamic Window_obj::setPosition( Dynamic inPos){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Window.hx",140)
	::wx::Window_obj::wx_window_set_position(this->wxHandle,inPos);
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Window.hx",141)
	return inPos;
}
...
bool Window_obj::isShown( ){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Window.hx",144)
...
bool Window_obj::show( Dynamic __o_inShow){
bool inShow = __o_inShow.Default(true);
	HX_SOURCE_PUSH("Window_obj::show");
{
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Window.hx",147)
		::wx::Window_obj::wx_window_set_shown(this->wxHandle,inShow);
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Window.hx",148)
		return inShow;
	}
}
...
int Window_obj::getBackgroundColour( ){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Window.hx",151)
...
int Window_obj::setBackgroundColour( int inColour){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Window.hx",154)
	::wx::Window_obj::wx_window_set_bg_colour(this->wxHandle,inColour);
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Window.hx",155)
	return inColour;
}
...
::String Window_obj::getName( ){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Window.hx",158)
...
::String Window_obj::setName( ::String inName){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Window.hx",161)
	::wx::Window_obj::wx_window_set_name(this->wxHandle,inName);
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Window.hx",162)
	return inName;
}
...
Dynamic Window_obj::setOnClose( Dynamic f){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Window.hx",168)
...
Dynamic Window_obj::setOnSize( Dynamic f){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Window.hx",170)
...
Dynamic Window_obj::setOnPaint( Dynamic f){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Window.hx",172)
	Dynamic f1 = Dynamic( Array_obj<Dynamic>::__new().Add(f));
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Window.hx",174)
	...
	Void run(Dynamic _){
{
			HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Window.hx",176)
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Window.hx",175)
	this->setHandler(::wx::EventID_obj::PAINT_dyn(), Dynamic(new _Function_1_1(me,f1)));
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Window.hx",177)
...
Dynamic Window_obj::setOnDropFiles( Dynamic f){
	HX_SOURCE_PUSH("Window_obj::setOnDropFiles")
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Window.hx",183)
	this->setHandler(::wx::EventID_obj::DROP_FILES_dyn(),f);
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Window.hx",183)
	return f;
}


HX_DEFINE_DYNAMIC_FUNC1(Window_obj,setOnDropFiles,return )
...
::wx::Window Window_obj::create( ::wx::Window inParent,Dynamic inID,Dynamic inPosition,Dynamic inSize,Dynamic inStyle){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Window.hx",72)
	if (((inParent == null()))){
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Window.hx",73)
		hx::Throw (::wx::Error_obj::INVALID_PARENT);
	}
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Window.hx",74)
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Window.hx",75)
...
void Window_obj::__Mark(HX_MARK_PARAMS)
{
	...
	HX_MARK_MEMBER_NAME(onDropFiles,"onDropFiles");
...
Dynamic Window_obj::__Field(const ::String &inName)
{
	...
	case 3:
		...
		break;
	case 4:
		if (HX_FIELD_EQ(inName,"size") ) { return getSize(); }
		if (HX_FIELD_EQ(inName,"name") ) { return getName(); }
		if (HX_FIELD_EQ(inName,"show") ) { return show_dyn(); }
		break;
	case 5:
		if (HX_FIELD_EQ(inName,"sizer") ) { return getSizer(); }
		if (HX_FIELD_EQ(inName,"shown") ) { return isShown(); }
		break;
	case 6:
	...
	case 9:
		...
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"clientSize") ) { return getClientSize(); }
	...
	case 11:
		...
		if (HX_FIELD_EQ(inName,"onDropFiles") ) { return onDropFiles; }
		break;
	case 12:
	...
	case 14:
		...
		if (HX_FIELD_EQ(inName,"setOnDropFiles") ) { return setOnDropFiles_dyn(); }
		break;
	case 15:
	...
	case 16:
		...
		if (HX_FIELD_EQ(inName,"backgroundColour") ) { return getBackgroundColour(); }
		break;
	case 17:
...
Dynamic Window_obj::__SetField(const ::String &inName,const Dynamic &inValue)
{
	switch(inName.length) {
	case 4:
		if (HX_FIELD_EQ(inName,"size") ) { return setSize(inValue); }
		if (HX_FIELD_EQ(inName,"name") ) { return setName(inValue); }
		break;
	case 5:
		if (HX_FIELD_EQ(inName,"sizer") ) { return setSizer(inValue); }
		if (HX_FIELD_EQ(inName,"shown") ) { return show(inValue); }
		break;
	case 6:
		if (HX_FIELD_EQ(inName,"CENTRE") ) { CENTRE=inValue.Cast< int >(); return inValue; }
		if (HX_FIELD_EQ(inName,"onSize") ) { return setOnSize(inValue); }
		break;
	case 7:
		...
		if (HX_FIELD_EQ(inName,"onClose") ) { return setOnClose(inValue); }
		if (HX_FIELD_EQ(inName,"onPaint") ) { return setOnPaint(inValue); }
		break;
	case 8:
	...
	case 9:
		...
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"clientSize") ) { return setClientSize(inValue); }
		break;
	case 11:
		...
		if (HX_FIELD_EQ(inName,"onDropFiles") ) { return setOnDropFiles(inValue); }
		break;
	case 12:
	...
	case 16:
		...
		if (HX_FIELD_EQ(inName,"backgroundColour") ) { return setBackgroundColour(inValue); }
		break;
	case 17:
...
static ::String sMemberFields[] = {
	...
	HX_CSTRING("onDropFiles"),
	HX_CSTRING("setOnDropFiles"),
	String(null()) };
