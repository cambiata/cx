...
Array< ::String > Resource_obj::listNames( ){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\std/cpp/_std/haxe/Resource.hx",30)
...
::String Resource_obj::getString( ::String name){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\std/cpp/_std/haxe/Resource.hx",33)
...
::haxe::io::Bytes Resource_obj::getBytes( ::String name){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\std/cpp/_std/haxe/Resource.hx",37)
	Array< unsigned char > array = ::__hxcpp_resource_bytes(name);
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\std/cpp/_std/haxe/Resource.hx",38)
	if (((array == null()))){
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\std/cpp/_std/haxe/Resource.hx",38)
		return null();
	}
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\std/cpp/_std/haxe/Resource.hx",39)
