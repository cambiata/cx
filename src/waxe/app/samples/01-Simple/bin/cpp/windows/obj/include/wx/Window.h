...
class Window_obj : public ::wx::EventHandler_obj{
	...
	public:
		...
		virtual bool show( Dynamic inShow);
		Dynamic show_dyn();
	...
	Dynamic &onPaint_dyn() { return onPaint;}
		...
		Dynamic onDropFiles; /* REM */ 
	Dynamic &onDropFiles_dyn() { return onDropFiles;}
		virtual Dynamic setOnDropFiles( Dynamic f);
		Dynamic setOnDropFiles_dyn();
	...
	Dynamic &wx_window_get_position_dyn() { return wx_window_get_position;}
		static Dynamic wx_window_set_position; /* REM */ 
	Dynamic &wx_window_set_position_dyn() { return wx_window_set_position;}
		static Dynamic wx_window_get_size; /* REM */ 
	Dynamic &wx_window_get_size_dyn() { return wx_window_get_size;}
		static Dynamic wx_window_set_size; /* REM */ 
	Dynamic &wx_window_set_size_dyn() { return wx_window_set_size;}
		static Dynamic wx_window_get_client_size; /* REM */ 
	Dynamic &wx_window_get_client_size_dyn() { return wx_window_get_client_size;}
		static Dynamic wx_window_set_client_size; /* REM */ 
	Dynamic &wx_window_set_client_size_dyn() { return wx_window_set_client_size;}
		static Dynamic wx_window_create; /* REM */ 
	Dynamic &wx_window_create_dyn() { return wx_window_create;}
		static Dynamic wx_window_set_sizer; /* REM */ 
	Dynamic &wx_window_set_sizer_dyn() { return wx_window_set_sizer;}
		static Dynamic wx_window_get_sizer; /* REM */ 
	Dynamic &wx_window_get_sizer_dyn() { return wx_window_get_sizer;}
		static Dynamic wx_window_fit; /* REM */ 
	Dynamic &wx_window_fit_dyn() { return wx_window_fit;}
		static Dynamic wx_window_get_shown; /* REM */ 
	Dynamic &wx_window_get_shown_dyn() { return wx_window_get_shown;}
		static Dynamic wx_window_set_shown; /* REM */ 
	Dynamic &wx_window_set_shown_dyn() { return wx_window_set_shown;}
		static Dynamic wx_window_get_bg_colour; /* REM */ 
	Dynamic &wx_window_get_bg_colour_dyn() { return wx_window_get_bg_colour;}
		static Dynamic wx_window_set_bg_colour; /* REM */ 
	Dynamic &wx_window_set_bg_colour_dyn() { return wx_window_set_bg_colour;}
		static Dynamic wx_window_get_name; /* REM */ 
	Dynamic &wx_window_get_name_dyn() { return wx_window_get_name;}
		static Dynamic wx_window_set_name; /* REM */ 
	Dynamic &wx_window_set_name_dyn() { return wx_window_set_name;}
		static Dynamic wx_window_refresh; /* REM */ 
	Dynamic &wx_window_refresh_dyn() { return wx_window_refresh;}
		static Dynamic wx_window_destroy; /* REM */ 
	Dynamic &wx_window_destroy_dyn() { return wx_window_destroy;}
};
