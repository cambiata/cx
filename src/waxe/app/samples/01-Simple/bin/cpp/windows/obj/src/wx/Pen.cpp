...
Void Pen_obj::__construct(::wx::Colour inColour,Dynamic __o_inWidth,Dynamic __o_inStyle)
{
int inWidth = __o_inWidth.Default(1);
int inStyle = __o_inStyle.Default(100);
{
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Pen.hx",16)
...
hx::ObjectPtr< Pen_obj > Pen_obj::__new(::wx::Colour inColour,Dynamic __o_inWidth,Dynamic __o_inStyle)
...
Dynamic Pen_obj::wxGetHandle( ){
	HX_SOURCE_PUSH("Pen_obj::wxGetHandle")
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Pen.hx",19)
...
Dynamic Pen_obj::__Field(const ::String &inName)
{
...
Dynamic Pen_obj::__SetField(const ::String &inName,const Dynamic &inValue)
{
	switch(inName.length) {
	case 3:
...
void Pen_obj::__boot()
{
	...
	hx::Static(DOT) = (int)101;
	hx::Static(LONG_DASH) = (int)102;
	hx::Static(SHORT_DASH) = (int)103;
	hx::Static(DOT_DASH) = (int)104;
	hx::Static(USER_DASH) = (int)105;
	hx::Static(TRANSPARENT) = (int)106;
	hx::Static(wx_pen_create) = ::wx::Loader_obj::load(HX_CSTRING("wx_pen_create"),(int)3);
}
