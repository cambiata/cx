...
{
		HX_STACK_PUSH("App::boot","wx/App.hx",6);
		HX_STACK_ARG(inOnInit,"inOnInit");
		HX_STACK_LINE(6)
...
Void App_obj::quit( ){
{
		HX_STACK_PUSH("App::quit","wx/App.hx",24);
		HX_STACK_LINE(24)
		::wx::App_obj::wx_quit();
	}
return null();
...
{
		HX_STACK_PUSH("App::setTopWindow","wx/App.hx",29);
...
static void sVisitStatics(HX_VISIT_PARAMS) {
	...
	HX_VISIT_MEMBER_NAME(App_obj::wx_set_top_window,"wx_set_top_window");
	HX_VISIT_MEMBER_NAME(App_obj::wx_boot,"wx_boot");
	HX_VISIT_MEMBER_NAME(App_obj::wx_quit,"wx_quit");
};
...
void App_obj::__boot()
{
	wx_set_top_window= ::wx::Loader_obj::load(HX_CSTRING("wx_set_top_window"),(int)1);
	wx_boot= ::wx::Loader_obj::load(HX_CSTRING("wx_boot"),(int)1);
	wx_quit= ::wx::Loader_obj::load(HX_CSTRING("wx_quit"),(int)0);
}
