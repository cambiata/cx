	...
	public static function main()
	{
		...
		nme.Lib.create(function()
			{ 
				...
				for (methodName in Type.getClassFields(HelloWaxe))
				{
					if (methodName == "main")
					{
						hasMain = true;
				...
				if (hasMain)
				{
					Reflect.callMethod (HelloWaxe, Reflect.field (HelloWaxe, "main"), []);
				}
				else
				{
					nme.Lib.current.addChild(cast (Type.createInstance(HelloWaxe, []), nme.display.DisplayObject));	
				}
			},
			600, 400, 
			24, 
