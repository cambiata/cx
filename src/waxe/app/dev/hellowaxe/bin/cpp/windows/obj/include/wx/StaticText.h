...
class StaticText_obj : public ::wx::Window_obj{
	...
	public:
		...
		::String label; /* REM */ 
		static ::wx::StaticText create( ::wx::Window inParent,Dynamic inID,::String inText,Dynamic inPosition,Dynamic inSize,Dynamic inStyle);
		static Dynamic create_dyn();

		static Dynamic wx_static_text_create; /* REM */ 
		static Dynamic &wx_static_text_create_dyn() { return wx_static_text_create;}
		static Dynamic wx_static_text_get_label; /* REM */ 
		static Dynamic &wx_static_text_get_label_dyn() { return wx_static_text_get_label;}
		static Dynamic wx_static_text_set_label; /* REM */ 
		static Dynamic &wx_static_text_set_label_dyn() { return wx_static_text_set_label;}
};
