...
{
{
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Bitmap.hx",7)
...
::wx::Bitmap Bitmap_obj::fromBytes( ::haxe::io::Bytes inBytes){
	HX_SOURCE_PUSH("Bitmap_obj::fromBytes")
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Bitmap.hx",11)
	if (((inBytes == null()))){
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Bitmap.hx",12)
		hx::Throw (HX_CSTRING("Bad bitmap data"));
	}
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Bitmap.hx",13)
...
::wx::Bitmap Bitmap_obj::fromResource( ::String inResorceName){
	HX_SOURCE_PUSH("Bitmap_obj::fromResource")
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Bitmap.hx",17)
...
{
	hx::Static(wx_bitmap_from_bytes) = ::wx::Loader_obj::load(HX_CSTRING("wx_bitmap_from_bytes"),(int)1);
}
