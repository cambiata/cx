...
Void Menu_obj::__construct(Dynamic __o_inTitle,Dynamic __o_inFlags)
{
::String inTitle = __o_inTitle.Default(HX_CSTRING(""));
int inFlags = __o_inFlags.Default(0);
{
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Menu.hx",12)
...
hx::ObjectPtr< Menu_obj > Menu_obj::__new(Dynamic __o_inTitle,Dynamic __o_inFlags)
...
Void Menu_obj::HandleEvent( Dynamic event){
{
		...
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Menu.hx",17)
...
HX_DEFINE_DYNAMIC_FUNC1(Menu_obj,HandleEvent,(void))

int Menu_obj::append( int inID,Dynamic __o_inItem,Dynamic __o_inHelp,Dynamic __o_inKind){
...
{
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Menu.hx",22)
		::wx::Menu_obj::wx_menu_append(this->wxHandle,inID,inItem,inHelp,inKind);
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Menu.hx",23)
		return inID;
	}
}
...
Void Menu_obj::appendSeparator( ){
{
		...
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Menu.hx",26)
...
Dynamic Menu_obj::__Field(const ::String &inName)
{
...
Dynamic Menu_obj::__SetField(const ::String &inName,const Dynamic &inValue)
{
	switch(inName.length) {
	case 5:
