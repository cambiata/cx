...
class TextCtrl_obj : public ::wx::Window_obj{
	...
	Dynamic &onTextUpdated_dyn() { return onTextUpdated;}
		...
		static ::wx::TextCtrl create( ::wx::Window inParent,Dynamic inID,Dynamic inText,Dynamic inPosition,Dynamic inSize,Dynamic inStyle);
		static Dynamic create_dyn();

		static Dynamic wx_text_ctrl_create; /* REM */ 
	Dynamic &wx_text_ctrl_create_dyn() { return wx_text_ctrl_create;}
		static Dynamic wx_text_ctrl_get_value; /* REM */ 
	Dynamic &wx_text_ctrl_get_value_dyn() { return wx_text_ctrl_get_value;}
		static Dynamic wx_text_ctrl_set_value; /* REM */ 
	Dynamic &wx_text_ctrl_set_value_dyn() { return wx_text_ctrl_set_value;}
};
