...
Dynamic Type_obj::allEnums( ::Enum e){
	...
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\std/cpp/_std/Type.hx",152)
	Dynamic all = Dynamic( Array_obj<Dynamic>::__new());
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\std/cpp/_std/Type.hx",153)
	hx::Throw (HX_CSTRING("TODO"));
	HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\std/cpp/_std/Type.hx",154)
	return all;
}
