...
class Window_obj : public ::wx::EventHandler_obj{
	...
	public:
		...
		virtual Void setScrollbar( Dynamic inScrollbar);
		...
		static Dynamic wx_window_set_scrollbar; /* REM */ 
		static Dynamic &wx_window_set_scrollbar_dyn() { return wx_window_set_scrollbar;}
};
