...
Void App_obj::boot( Dynamic inOnInit){
{
		...
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/App.hx",6)
...
Void App_obj::quit( ){
{
		...
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/App.hx",24)
		::wx::App_obj::wx_quit();
	}
return null();
}
...
Void App_obj::setTopWindow( ::wx::TopLevelWindow inWindow){
{
		...
		HX_SOURCE_POS("C:\\Program Files\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/App.hx",29)
...
Dynamic App_obj::__Field(const ::String &inName)
{
...
Dynamic App_obj::__SetField(const ::String &inName,const Dynamic &inValue)
{
	switch(inName.length) {
	case 7:
