...
class Brush_obj : public hx::Object{
	public:
		...
		Brush_obj();
		Void __construct(::wx::Colour inColour,Dynamic __o_inStyle);

	public:
		static hx::ObjectPtr< Brush_obj > __new(::wx::Colour inColour,Dynamic __o_inStyle);
	...
	Dynamic &wx_brush_create_dyn() { return wx_brush_create;}
};
