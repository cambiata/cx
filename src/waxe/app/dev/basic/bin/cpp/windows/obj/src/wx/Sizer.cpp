...
{
HX_STACK_PUSH("Sizer::new","wx/Sizer.hx",36);
{
	HX_STACK_LINE(37)
...
Dynamic Sizer_obj::wxGetHandle( ){
	HX_STACK_PUSH("Sizer::wxGetHandle","wx/Sizer.hx",68);
	HX_STACK_THIS(this);
	HX_STACK_LINE(68)
...
{
		HX_STACK_PUSH("Sizer::fit","wx/Sizer.hx",65);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("Sizer::setSizeHints","wx/Sizer.hx",60);
		HX_STACK_THIS(this);
		HX_STACK_ARG(inWindow,"inWindow");
		HX_STACK_LINE(60)
...
{
		HX_STACK_PUSH("Sizer::addStretchSpacer","wx/Sizer.hx",53);
		HX_STACK_THIS(this);
		HX_STACK_ARG(inProportion,"inProportion");
		HX_STACK_LINE(53)
...
{
		HX_STACK_PUSH("Sizer::addSpacer","wx/Sizer.hx",49);
		HX_STACK_THIS(this);
...
int border = __o_border.Default(0);
	HX_STACK_PUSH("Sizer::add","wx/Sizer.hx",44);
	HX_STACK_THIS(this);
	HX_STACK_ARG(sizerOrWindow,"sizerOrWindow");
	HX_STACK_ARG(proportion,"proportion");
	HX_STACK_ARG(flag,"flag");
	HX_STACK_ARG(border,"border");
{
		HX_STACK_LINE(45)
		Dynamic handle = ::Reflect_obj::field(sizerOrWindow,HX_CSTRING("wxHandle"));		HX_STACK_VAR(handle,"handle");
		HX_STACK_LINE(46)
...
{
		HX_STACK_PUSH("Sizer::_wx_deleted","wx/Sizer.hx",41);
		HX_STACK_THIS(this);
		HX_STACK_LINE(41)
		this->wxHandle = null();
	}
...
static void sVisitStatics(HX_VISIT_PARAMS) {
	...
	HX_VISIT_MEMBER_NAME(Sizer_obj::BORDER_LEFT,"BORDER_LEFT");
	HX_VISIT_MEMBER_NAME(Sizer_obj::BORDER_RIGHT,"BORDER_RIGHT");
	HX_VISIT_MEMBER_NAME(Sizer_obj::BORDER_UP,"BORDER_UP");
	HX_VISIT_MEMBER_NAME(Sizer_obj::BORDER_DOWN,"BORDER_DOWN");
	HX_VISIT_MEMBER_NAME(Sizer_obj::BORDER_TOP,"BORDER_TOP");
	HX_VISIT_MEMBER_NAME(Sizer_obj::BORDER_BOTTOM,"BORDER_BOTTOM");
	HX_VISIT_MEMBER_NAME(Sizer_obj::BORDER_ALL,"BORDER_ALL");
	HX_VISIT_MEMBER_NAME(Sizer_obj::EXPAND,"EXPAND");
	HX_VISIT_MEMBER_NAME(Sizer_obj::ALIGN_NOT,"ALIGN_NOT");
	HX_VISIT_MEMBER_NAME(Sizer_obj::ALIGN_CENTER_HORIZONTAL,"ALIGN_CENTER_HORIZONTAL");
	HX_VISIT_MEMBER_NAME(Sizer_obj::ALIGN_CENTRE_HORIZONTAL,"ALIGN_CENTRE_HORIZONTAL");
	HX_VISIT_MEMBER_NAME(Sizer_obj::ALIGN_LEFT,"ALIGN_LEFT");
	HX_VISIT_MEMBER_NAME(Sizer_obj::ALIGN_TOP,"ALIGN_TOP");
	HX_VISIT_MEMBER_NAME(Sizer_obj::ALIGN_RIGHT,"ALIGN_RIGHT");
	HX_VISIT_MEMBER_NAME(Sizer_obj::ALIGN_BOTTOM,"ALIGN_BOTTOM");
	HX_VISIT_MEMBER_NAME(Sizer_obj::ALIGN_CENTER_VERTICAL,"ALIGN_CENTER_VERTICAL");
	HX_VISIT_MEMBER_NAME(Sizer_obj::ALIGN_CENTRE_VERTICAL,"ALIGN_CENTRE_VERTICAL");
	HX_VISIT_MEMBER_NAME(Sizer_obj::ALIGN_CENTER,"ALIGN_CENTER");
	HX_VISIT_MEMBER_NAME(Sizer_obj::ALIGN_CENTRE,"ALIGN_CENTRE");
	HX_VISIT_MEMBER_NAME(Sizer_obj::ALIGN_MASK,"ALIGN_MASK");
	HX_VISIT_MEMBER_NAME(Sizer_obj::wx_set_data,"wx_set_data");
	HX_VISIT_MEMBER_NAME(Sizer_obj::wx_get_data,"wx_get_data");
	HX_VISIT_MEMBER_NAME(Sizer_obj::wx_sizer_add,"wx_sizer_add");
	HX_VISIT_MEMBER_NAME(Sizer_obj::wx_sizer_add_spacer,"wx_sizer_add_spacer");
	HX_VISIT_MEMBER_NAME(Sizer_obj::wx_sizer_set_size_hints,"wx_sizer_set_size_hints");
	HX_VISIT_MEMBER_NAME(Sizer_obj::wx_sizer_fit,"wx_sizer_fit");
};
...
void Sizer_obj::__boot()
{
	...
	BORDER_DOWN= (int)128;
	BORDER_TOP= (int)64;
	BORDER_BOTTOM= (int)128;
	BORDER_ALL= (int)240;
	EXPAND= (int)8192;
	ALIGN_NOT= (int)0;
	ALIGN_CENTER_HORIZONTAL= (int)256;
	ALIGN_CENTRE_HORIZONTAL= (int)256;
	ALIGN_LEFT= (int)0;
	ALIGN_TOP= (int)0;
	ALIGN_RIGHT= (int)512;
	ALIGN_BOTTOM= (int)1024;
	ALIGN_CENTER_VERTICAL= (int)2048;
	ALIGN_CENTRE_VERTICAL= (int)2048;
	ALIGN_CENTER= (int)2304;
	ALIGN_CENTRE= (int)2304;
	ALIGN_MASK= (int)3840;
	wx_set_data= ::wx::Loader_obj::load(HX_CSTRING("wx_set_data"),(int)2);
	wx_get_data= ::wx::Loader_obj::load(HX_CSTRING("wx_get_data"),(int)1);
	wx_sizer_add= ::wx::Loader_obj::load(HX_CSTRING("wx_sizer_add"),(int)5);
	wx_sizer_add_spacer= ::wx::Loader_obj::load(HX_CSTRING("wx_sizer_add_spacer"),(int)3);
	wx_sizer_set_size_hints= ::wx::Loader_obj::load(HX_CSTRING("wx_sizer_set_size_hints"),(int)2);
	wx_sizer_fit= ::wx::Loader_obj::load(HX_CSTRING("wx_sizer_fit"),(int)2);
}
