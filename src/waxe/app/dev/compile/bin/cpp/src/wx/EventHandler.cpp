...
{
{
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/EventHandler.hx",9)
	this->wxHandle = inHandle;
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/EventHandler.hx",10)
	if (((this->wxHandle != null()))){
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/EventHandler.hx",11)
...
Void EventHandler_obj::_wx_deleted( ){
{
		...
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/EventHandler.hx",15)
		this->wxHandle = null();
	}
return null();
}
...
Void EventHandler_obj::_handle_event( Dynamic event){
{
		...
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/EventHandler.hx",16)
