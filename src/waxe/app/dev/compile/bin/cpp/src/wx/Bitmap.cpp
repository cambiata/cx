...
{
{
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Bitmap.hx",7)
...
::wx::Bitmap Bitmap_obj::fromBytes( ::haxe::io::Bytes inBytes){
	...
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Bitmap.hx",11)
	if (((inBytes == null()))){
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Bitmap.hx",12)
		hx::Throw (HX_CSTRING("Bad bitmap data"));
	}
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Bitmap.hx",13)
...
::wx::Bitmap Bitmap_obj::fromResource( ::String inResorceName){
	...
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Bitmap.hx",17)
