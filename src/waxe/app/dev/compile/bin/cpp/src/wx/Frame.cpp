...
{
{
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Frame.hx",20)
	super::__construct(inHandle);
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Frame.hx",21)
	this->setHandler(::wx::EventID_obj::COMMAND_MENU_SELECTED_dyn(),this->onMenu_dyn());
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Frame.hx",22)
...
::wx::MenuBar Frame_obj::wxSetMenuBar( ::wx::MenuBar inBar){
	...
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Frame.hx",27)
	::wx::Frame_obj::wx_frame_set_menu_bar(this->wxHandle,inBar->wxHandle);
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Frame.hx",28)
	return inBar;
}
...
Void Frame_obj::handle( int id,Dynamic handler){
{
		...
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Frame.hx",32)
...
Void Frame_obj::onMenu( Dynamic event){
{
		...
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Frame.hx",38)
		int id = event->__Field(HX_CSTRING("id"),true);
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Frame.hx",39)
		if ((this->menuMap->exists(id))){
			HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Frame.hx",40)
...
::wx::Frame Frame_obj::create( ::wx::Window inParent,Dynamic inID,hx::Null< ::String >  __o_inTitle,Dynamic inPosition,Dynamic inSize,Dynamic inStyle){
::String inTitle = __o_inTitle.Default(HX_CSTRING(""));
	HX_SOURCE_PUSH("Frame_obj::create");
{
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Frame.hx",12)
		...
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Frame.hx",14)
