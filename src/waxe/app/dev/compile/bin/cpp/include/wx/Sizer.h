...
class Sizer_obj : public hx::Object{
	...
	public:
		...
		virtual Void add( Dynamic sizerOrWindow,hx::Null< int >  proportion,hx::Null< int >  flag,hx::Null< int >  border);
		Dynamic add_dyn();
		...
		static Dynamic &wx_set_data_dyn() { return wx_set_data;}
		static Dynamic wx_get_data; /* REM */ 
		static Dynamic wx_sizer_add; /* REM */ 
		static Dynamic &wx_sizer_add_dyn() { return wx_sizer_add;}
		static Dynamic wx_sizer_add_spacer; /* REM */ 
		static Dynamic &wx_sizer_add_spacer_dyn() { return wx_sizer_add_spacer;}
		static Dynamic wx_sizer_set_size_hints; /* REM */ 
		static Dynamic &wx_sizer_set_size_hints_dyn() { return wx_sizer_set_size_hints;}
		static Dynamic wx_sizer_fit; /* REM */ 
		static Dynamic &wx_sizer_fit_dyn() { return wx_sizer_fit;}
};
