...
class DC_obj : public hx::Object{
	...
	public:
		...
		static Dynamic &wx_dc_create_paint_dyn() { return wx_dc_create_paint;}
		static Dynamic wx_dc_draw_line; /* REM */ 
		static Dynamic &wx_dc_draw_line_dyn() { return wx_dc_draw_line;}
		static Dynamic wx_object_destroy; /* REM */ 
		static Dynamic &wx_object_destroy_dyn() { return wx_object_destroy;}
		static Dynamic wx_dc_clear; /* REM */ 
		static Dynamic &wx_dc_clear_dyn() { return wx_dc_clear;}
		static Dynamic wx_dc_set_pen; /* REM */ 
		static Dynamic &wx_dc_set_pen_dyn() { return wx_dc_set_pen;}
		static Dynamic wx_dc_set_font; /* REM */ 
		static Dynamic &wx_dc_set_font_dyn() { return wx_dc_set_font;}
		static Dynamic wx_dc_set_brush; /* REM */ 
		static Dynamic &wx_dc_set_brush_dyn() { return wx_dc_set_brush;}
		static Dynamic wx_dc_set_background; /* REM */ 
		static Dynamic &wx_dc_set_background_dyn() { return wx_dc_set_background;}
		static Dynamic wx_dc_draw_rectangle; /* REM */ 
		static Dynamic &wx_dc_draw_rectangle_dyn() { return wx_dc_draw_rectangle;}
		static Dynamic wx_dc_draw_circle; /* REM */ 
		static Dynamic &wx_dc_draw_circle_dyn() { return wx_dc_draw_circle;}
		static Dynamic wx_dc_draw_ellipse; /* REM */ 
		static Dynamic &wx_dc_draw_ellipse_dyn() { return wx_dc_draw_ellipse;}
		static Dynamic wx_dc_draw_text; /* REM */ 
		static Dynamic &wx_dc_draw_text_dyn() { return wx_dc_draw_text;}
		static Dynamic wx_dc_draw_bitmap; /* REM */ 
		static Dynamic &wx_dc_draw_bitmap_dyn() { return wx_dc_draw_bitmap;}
};
