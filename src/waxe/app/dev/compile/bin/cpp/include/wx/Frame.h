...
class Frame_obj : public ::wx::TopLevelWindow_obj{
	...
	public:
		...
		static ::wx::Frame create( ::wx::Window inParent,Dynamic inID,hx::Null< ::String >  inTitle,Dynamic inPosition,Dynamic inSize,Dynamic inStyle);
		static Dynamic create_dyn();

		static Dynamic wx_frame_create; /* REM */ 
		static Dynamic &wx_frame_create_dyn() { return wx_frame_create;}
		static Dynamic wx_frame_set_menu_bar; /* REM */ 
		static Dynamic &wx_frame_set_menu_bar_dyn() { return wx_frame_set_menu_bar;}
};
