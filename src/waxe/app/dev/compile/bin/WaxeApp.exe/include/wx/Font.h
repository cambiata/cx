...
class Font_obj : public hx::Object{
	public:
		...
		Font_obj();
		Void __construct(int size,hx::Null< int >  __o_family,hx::Null< int >  __o_style,hx::Null< int >  __o_weight,hx::Null< bool >  __o_underline,hx::Null< ::String >  __o_faceName);

	public:
		static hx::ObjectPtr< Font_obj > __new(int size,hx::Null< int >  __o_family,hx::Null< int >  __o_style,hx::Null< int >  __o_weight,hx::Null< bool >  __o_underline,hx::Null< ::String >  __o_faceName);
