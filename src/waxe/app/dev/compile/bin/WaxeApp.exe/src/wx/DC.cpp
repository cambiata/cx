...
{
{
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/DC.hx",12)
...
Void DC_obj::destroy( ){
{
		...
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/DC.hx",15)
...
Void DC_obj::drawLine( int x1,int y1,int x2,int y2){
{
		...
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/DC.hx",18)
...
Void DC_obj::clear( ){
{
		...
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/DC.hx",22)
...
::wx::Pen DC_obj::setPen( ::wx::Pen inPen){
	...
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/DC.hx",27)
	::wx::DC_obj::wx_dc_set_pen(this->wxHandle,inPen->wxGetHandle());
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/DC.hx",28)
	return inPen;
}
...
::wx::Brush DC_obj::setBrush( ::wx::Brush inBrush){
	...
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/DC.hx",32)
	::wx::DC_obj::wx_dc_set_brush(this->wxHandle,inBrush->wxGetHandle());
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/DC.hx",33)
	return inBrush;
}
...
::wx::Brush DC_obj::setBackground( ::wx::Brush inBrush){
	...
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/DC.hx",37)
	::wx::DC_obj::wx_dc_set_background(this->wxHandle,inBrush->wxGetHandle());
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/DC.hx",38)
	return inBrush;
}
...
::wx::Font DC_obj::setFont( ::wx::Font inFont){
	...
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/DC.hx",42)
	::wx::DC_obj::wx_dc_set_font(this->wxHandle,inFont->wxGetHandle());
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/DC.hx",43)
	return inFont;
}
...
Void DC_obj::drawRectangle( int x,int y,int width,int height){
{
		...
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/DC.hx",46)
...
Void DC_obj::drawCircle( int x,int y,int rad){
{
		...
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/DC.hx",50)
...
Void DC_obj::drawEllipse( int x,int y,int width,int height){
{
		...
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/DC.hx",54)
...
Void DC_obj::drawText( ::String text,int x,int y){
{
		...
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/DC.hx",58)
...
Void DC_obj::drawBitmap( ::wx::Bitmap bitmap,int x,int y,bool inTransparent){
{
		...
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/DC.hx",62)
...
::wx::DC DC_obj::createPaintDC( ::wx::Window inWindow){
	...
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/DC.hx",67)
