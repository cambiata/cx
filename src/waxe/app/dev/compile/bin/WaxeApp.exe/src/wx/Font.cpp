...
Void Font_obj::__construct(int size,hx::Null< int >  __o_family,hx::Null< int >  __o_style,hx::Null< int >  __o_weight,hx::Null< bool >  __o_underline,hx::Null< ::String >  __o_faceName)
{
...
{
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Font.hx",29)
...
hx::ObjectPtr< Font_obj > Font_obj::__new(int size,hx::Null< int >  __o_family,hx::Null< int >  __o_style,hx::Null< int >  __o_weight,hx::Null< bool >  __o_underline,hx::Null< ::String >  __o_faceName)
...
Dynamic Font_obj::wxGetHandle( ){
	HX_SOURCE_PUSH("Font_obj::wxGetHandle")
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Font.hx",32)
...
{
	hx::Static(FAMILY_DEFAULT) = (int)70;
	hx::Static(FAMILY_DECORATIVE) = (int)71;
	hx::Static(FAMILY_ROMAN) = (int)72;
	hx::Static(FAMILY_SCRIPT) = (int)73;
	hx::Static(FAMILY_SWISS) = (int)74;
	hx::Static(FAMILY_MODERN) = (int)75;
	hx::Static(FAMILY_TELETYPE) = (int)76;
	hx::Static(STYLE_NORMAL) = (int)90;
	hx::Static(STYLE_SLANT) = (int)92;
	hx::Static(STYLE_ITALIC) = (int)93;
	hx::Static(WEIGHT_NORMAL) = (int)90;
	hx::Static(WEIGHT_LIGHT) = (int)91;
	hx::Static(WEIGHT_BOLD) = (int)92;
	hx::Static(wx_font_create) = ::wx::Loader_obj::load(HX_CSTRING("wx_font_create"),(int)-1);
}
