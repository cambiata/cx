...
{
{
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Button.hx",23)
...
Dynamic Button_obj::setOnClick( Dynamic f){
	...
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Button.hx",27)
...
::String Button_obj::setLabel( ::String inString){
	...
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Button.hx",31)
	::wx::Button_obj::wx_button_set_label(this->wxHandle,inString);
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Button.hx",32)
	return inString;
}
...
::String Button_obj::getLabel( ){
	...
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Button.hx",35)
...
::wx::Button Button_obj::create( ::wx::Window inParent,Dynamic inID,hx::Null< ::String >  __o_inLabel,Dynamic inPosition,Dynamic inSize,Dynamic inStyle){
::String inLabel = __o_inLabel.Default(HX_CSTRING(""));
	HX_SOURCE_PUSH("Button_obj::create");
{
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Button.hx",14)
		if (((inParent == null()))){
			HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Button.hx",15)
			hx::Throw (::wx::Error_obj::INVALID_PARENT);
		}
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Button.hx",16)
		...
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\waxe/1,0,1/wx/Button.hx",18)
